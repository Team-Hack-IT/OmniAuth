    ...
    return (
        <section className='flex justify-evenly items-center gap-x-10 bg-tertiary min-h-[600px] p-6'>
            ...
            <div className='  text-white '>
                <h2 className=" text-md md:text-4xl w-full lg:w-[600px] pb-10">Guaranteed robust and secure identiy management platform for users</h2>
                <p className="w-[320px] pt-3 pb-10">We ensure the highest level of security for user authentication and data management</p>
                <Link to="/login" className="bg-button text-white px-10 py-3 border-0 rounded-lg">Sign In</Link>
            </div> 
